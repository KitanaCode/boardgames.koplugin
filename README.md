...
function ButtonTable:init()
    ...
    for i = 1, row_cnt do
        ...
        local default_button_width = unspecified_width_buttons > 0
            and math.floor(available_width / unspecified_width_buttons)
            or 0
        ...
        for j = 1, column_cnt do
            ...
            local button = Button:new{
                ...
                bordersize = 0,
                margin = 0,
                padding = btn_entry.padding or Size.padding.buttontable, -- board squares can override this to 0
                padding_h = btn_entry.padding_h or (btn_entry.align == "left" and Size.padding.large or Size.padding.button),
                padding_v = btn_entry.padding_v,
